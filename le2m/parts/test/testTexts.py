...
# 2) entourer les expressions à traduire par _TT()
# 3) dans le projet créer les dossiers locale/fr_FR/LC_MESSAGES
# en remplaçant fr_FR par la langue souhaitée
# 4) créer le fichier test.po: dans invite de commande, taper:
# xgettext fichierTextes.py -p locale/fr_FR/LC_MESSAGES -d test
# 5) avec poedit, éditer le fichier test.po qui a été créé

# import os
# import configuration.configparam as params
# import gettext
# localedir = os.path.join(params.getp("PARTSDIR"), "test", "locale")
# _TT = gettext.translation(
#   "test", localedir, languages=[params.getp("LANG")]).ugettext
