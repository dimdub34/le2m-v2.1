...
class PartieTC(Partie, pb.Referenceable):
    ...
    def display_decision(self):
        ...
        self.joueur.info(u"NBA{} GA {} NBL {} NBT {} NBMS {} NBMR {}".format(
    ...
    def display_summary(self):
        ...
        yield (self.joueur.get_part("base").remote.callRemote(
            "display_information", self._texte_recapitulatif))
        self.joueur.info("Ok")
        self.joueur.remove_waitmode()
    ...
    def compute_partpayoff(self):
        ...
        self._texte_final = texts.get_texte_final(
            self.TC_gain_ecus, self.TC_gain_euros)
        self.sequences[self._currentsequence]["texte_final"] = self._texte_final
